...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-md font-medium text-center transition-colors disabled:bg-button-contrast disabled:pointer-events-none [&>svg]:w-6 [&>svg]:h-6 " +
  // for accessibility
